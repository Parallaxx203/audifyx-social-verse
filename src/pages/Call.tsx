...
import { PhoneCall, Video, Mic, MicOff } from "lucide-react";
        ...
        <main className={`flex-1 ${isMobile ? 'ml-0' : 'ml-64'} px-4 py-8`}>
          <div className="max-w-2xl mx-auto flex flex-col gap-8">
            <h1 className="text-2xl font-bold mb-2 flex items-center gap-2">
              <PhoneCall className="w-6 h-6"/> Audio & Video Chat with Artists and Friends
            </h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-audifyx-purple-dark/80 rounded-xl p-6 flex flex-col items-center">
                ...
                <Button className="bg-audifyx-purple">Start Audio Call</Button>
              </div>
              <div className="bg-audifyx-purple-dark/80 rounded-xl p-6 flex flex-col items-center">
                <Video className="w-8 h-8 mb-2" />
                <p className="mb-4 text-lg">Face-to-face meetings made easy.</p>
                <Button className="bg-audifyx-purple">Start Video Call</Button>
              </div>
            </div>
