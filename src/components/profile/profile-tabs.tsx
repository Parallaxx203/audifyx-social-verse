...
export function ProfileTabs({ isOwnProfile = true, accountType = "listener" }: ProfileTabsProps) {
    ...
    >
      ...
      <TabsContent value="following" className="mt-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Card className="p-4 border-audifyx-purple/20 bg-gradient-card flex items-center justify-center text-gray-400 h-24">
